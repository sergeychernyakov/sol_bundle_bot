import { connection, wallet, walletconn, tipAcct } from "../config";
...
import { ammCreatePool, getWalletTokenAccount } from "../clients/raydium_until";
import { promises as fsPromises } from 'fs';
import { loadKeypairs } from './create_keys_service';
import { lookupTableProvider } from "../clients/look_up_table_provider";
...
async function writeDetailsToJsonFile(associatedPoolKeys: AssociatedPoolKeys, startTime: number) {
